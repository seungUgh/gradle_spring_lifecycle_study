...
import gradle_spring_lifecycle_study.assembler.Assembler;
...
import gradle_spring_lifecycle_study.spring.MemberNotFoundExeception;
...
//		ctx = new AnnotationConfigApplicationContext(AppCtx.class);
	...
	private static void processNewCommand(String[] arg) {
		...
		MemberRegisterService regSvc = assmbler.getMemberRegisterService();
//		MemberRegisterService regSvc = ctx.getBean("memberRegSvc", MemberRegisterService.class);
	...
	private static void processChangeCommand(String[] arg) {
		...
		ChangePasswordSerivce changePwdSvc = assmbler.getChangePasswordSerivce();
//		ChangePasswordSerivce changePwdSvc = ctx.getBean("changePwdSvc", ChangePasswordSerivce.class);
		try {
			changePwdSvc.changePassword(arg[1], arg[2], arg[3]);
			System.out.println("암호를 변경했습니다.\n");
		}catch(MemberNotFoundExeception e) {
